...
<main class="app-content">
    <div class="app-title">
        <div>
            <h1> <i class="icofont-list"></i> Add Brands Form </h1>
        </div>
                ...
                <div class="tile-body">
                    <form action="insertData.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="name_id" name="brandName">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-10">
                                <button type="submit" class="btn btn-primary" name="brandAdd">
